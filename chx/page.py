...
class Page(object):
    ...
    def highlight_web_element(self,element,color='red',timeout=1):
        ...
        if config.highlight_web_elements is False:
            return
    ...
    def scroll_to_element(self,element):
        ...
        if config.scroll_to_web_elements is False:
            return
    ...
    def _next_marker(self):
        self._marker = random.randint(0,9999999999)
    ...
    def set_page_load_marker(self):
        ...
        self._browser.execute_script(
            ...
            % self._marker)
        self.logger.debug("setting page marker: '%s'" % (self._marker))

        loc = "body[hc_page_load_marker='%s']" % self._marker
